-- TODO: Test if `require('pluginname')` is slower than having the config in here, if it is I should move small (<15 lines) configs in here
...
return require('packer').startup(
  function(use)
    ...
    -- TODO: If I decide to swap to Null LS this can be completely removed
    use {
    ...
    -- TODO: Does this actually matter to me?
    -- use {
